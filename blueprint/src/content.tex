...
\begin{definition}[Chebyshev polynomial of the first kind]
  \label{def:T}
  \lean{RingTheory.Polynomial.Chebyshev.T}
  \leanok
...
\begin{definition}[Chebyshev polynomial of the second kind]
  \label{def:U}
  \lean{RingTheory.Polynomial.Chebyshev.U}
  \leanok
...
\begin{lemma}[]
  ...
  \lean{Polynomial.Chebyshev.T_derivative_eq_U}
  \leanok
...
\begin{lemma}[]
  ...
  \lean{Polynomial.Chebyshev.T_real_cos}
  \leanok
